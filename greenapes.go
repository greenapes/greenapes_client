...
func (self *Error) JsonError() ([]byte, error) {
...
type SecretTokenLoginRequest struct {
	LoginRequest
...
func (self *ApiServer) SecretTokenLogin(req SecretTokenLoginRequest) (LoginResponse, error) {
	resp := LoginResponse{}
